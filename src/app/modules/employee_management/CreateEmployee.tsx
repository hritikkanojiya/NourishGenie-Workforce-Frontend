        ...
        const res = await axios.post(
          url,
          {
            ...
            date_of_birth: new Date(
              Number(values.date_of_birth.split('-')[2]),
              Number(values.date_of_birth.split('-')[1]),
              Number(values.date_of_birth.split('-')[0])
            ),
            date_of_joining: new Date(
              Number(values.date_of_joining.split('-')[2]),
              Number(values.date_of_joining.split('-')[1]),
              Number(values.date_of_joining.split('-')[0])
            ),
        ...
        <form onSubmit={formik.handleSubmit} noValidate className='form'>
          ...
          <div className='card-header border-0 cursor-pointer'>
            <div className='card-title m-0'>
              <h3 className='fw-bolder m-0'>Create a new Genie</h3>
            </div>
          </div>
