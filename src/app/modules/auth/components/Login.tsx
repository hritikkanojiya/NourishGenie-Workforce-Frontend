  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, {setStatus, setSubmitting}) => {
      ...
      try {
        ...
        console.log(auth)
        saveAuth(auth)
        //const {data: user} = await getUserByToken(auth.jwt_token)
        //console.log(user)
        // const data = await getUserByToken(auth.data.jwtToken)
  ...
  return (
    ...
    >
      ...
      <div className='text-center mb-11'>
        ...
        <div className='text-gray-500 fw-semibold fs-6'>Sign In to your Account</div>
      </div>
      {/* begin::Heading */}
